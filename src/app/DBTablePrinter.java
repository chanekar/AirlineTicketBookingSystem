    ...
    public static void printResultSet(ResultSet rs, int maxStringColWidth) {
        try {
            ...
            for (int i = 1; i <= columnCount; i++) {
            	...
            	String columnName = rsmd.getColumnLabel(i).substring(0,1).toUpperCase() + rsmd.getColumnLabel(i).substring(1);
            	
            	if (rsmd.getColumnName(i).equals("id")) columnName = "ID";
            	if (rsmd.getColumnName(i).equals("depTime")) columnName = "Departure Time";
            	if (rsmd.getColumnName(i).equals("arrTime")) columnName = "Arrival Time";
            	if (rsmd.getColumnName(i).equals("emptySeats")) columnName = "Empty Seats";
            	if (rsmd.getColumnName(i).equals("totalSeats")) columnName = "Total Seats";
...
//            System.out.println(info);
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                	...
                	String columnValue = c.getValue(i);
                	// System.out.println(c.getLabel());
                	
                	if (c.getLabel().equals("Price")) columnValue = "$" + columnValue;
    		        if (c.getLabel().equals("Type")) {
    		        	if (columnValue.equals("0")) columnValue = "OW";
    		        	else columnValue = "RT";
    		        }
                    ...
                    System.out.print(
                            String.format(format, columnValue)
                    );
                }
